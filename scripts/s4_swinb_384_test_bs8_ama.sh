#!/bin/bash
# ============================================================
# S4 Training with AMA Module - 测试脚本
# ============================================================
# 用法:
#   bash scripts/s4_swinb_384_test_bs8_ama.sh                          # 使用默认训练好的权重
#   bash scripts/s4_swinb_384_test_bs8_ama.sh path/to/weights.pth      # 指定权重文件
# ============================================================
...
# 默认使用 AMA only 训练的权重
weights=${1:-"/media/a100/c5e1bf65-7974-432f-8aed-7a1345241efe/hhj/VCT_AVS/output/s4_swinb_384_bs8_ama/model_best.pth"}
