...
# ============================================================
# 用法:
#   bash scripts/ms3_swinb_384_test_ama_brm_v2.sh                     # 使用默认训练好的权重
#   bash scripts/ms3_swinb_384_test_ama_brm_v2.sh path/to/weights.pth # 指定权重文件
# ============================================================
...
# 默认使用 AMA+BRM v2 训练的权重
weights=${1:-"/media/a100/c5e1bf65-7974-432f-8aed-7a1345241efe/hhj/VCT_AVS/output/ms3_swinb_384_ama_brm_v2/model_best.pth"}

echo "=== MS3 + AMA + BRM v2 测试 ==="
echo "权重文件: $weights"
echo ""
