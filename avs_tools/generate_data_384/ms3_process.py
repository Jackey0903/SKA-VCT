...
ss_root = os.path.join(DATASET_ROOT, "AVSBench_semantic")
ms3_root = os.path.join(DATASET_ROOT, "AVSBench_object/Multi-sources/ms3_data_384")

ss_csv_path = os.path.join(DATASET_ROOT, "AVSBench_semantic/metadata.csv")
ms3_csv_path = os.path.join(DATASET_ROOT, "AVSBench_object/Multi-sources/ms3_meta_data.csv")
